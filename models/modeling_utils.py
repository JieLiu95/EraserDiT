...
from models.hooks import apply_group_offloading, apply_layerwise_casting
...
def get_parameter_device(parameter: torch.nn.Module) -> torch.device:
    from models.hooks.group_offloading import _get_group_onload_device
...
class ModelMixin(torch.nn.Module, PushToHubMixin):
    ...
    def enable_layerwise_casting(
        ...
        if skip_modules_pattern is None:
            from models.hooks.layerwise_casting import DEFAULT_SKIP_MODULES_PATTERN
    ...
    def cuda(self, *args, **kwargs):
        from models.hooks.group_offloading import _is_group_offload_enabled
